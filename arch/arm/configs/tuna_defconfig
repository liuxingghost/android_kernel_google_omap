...
# CONFIG_UMTS_LINK_HSIC is not set
...
CONFIG_REMOTE_PROC_AUTOSUSPEND=y
CONFIG_OMAP_REMOTE_PROC=y
CONFIG_OMAP_RPRES=y
CONFIG_REMOTEPROC_WATCHDOG=y
CONFIG_REMOTEPROC_CORE_DUMP=y
CONFIG_VIRTIO=y
...
# CONFIG_RPMSG_CLIENT_SAMPLE is not set
# CONFIG_RPMSG_SERVER_SAMPLE is not set
CONFIG_OMAP_HSI=y
CONFIG_OMAP_HSI_DEVICE=y
# CONFIG_OMAP_HSI_CHAR is not set
